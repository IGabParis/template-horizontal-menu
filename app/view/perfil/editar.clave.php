 ...
 ?>
      ...
      <?php include('../includes/menu.php'); ?>
          <section class="container-section">            
    			  <div class="row">
    				<div class="col-lg-12">
    					<h3 class="page-header title-bg"><i class="fa fa-laptop"></i> Edicion de Clave</h3>
    					<ol class="breadcrumb">
    						<li><i class="fa fa-home"></i><a href="../index/home.php">Inicio</a></li>
    						<li><i class="fa fa-laptop"></i>Perfil</li>
                <li><i class="fa fa-laptop"></i>Editar Clave</li>
    					</ol>
    				</div>
    			</div>
          <?php 
    			...
    			<div class="row">
    				<div class="col-lg-12 col-md-12">	
                      ...
                      <div class="form-group col-lg-6 col-sm-12">
                        <label for="clave_nuev">Nueva Clave</label>
                        <input type="password" class="form-control" placeholder="Nueva Clave" name="clave_nuev" id="clave_nuev" />
                      </div>
                      <div class="form-group col-lg-6 col-sm-12">
                        <label for="clave_conf">Confirmar Clave</label>
                        <input type="password" class="form-control" placeholder="Confirmar Clave" name="clave_conf" id="clave_conf" />
                      </div>
