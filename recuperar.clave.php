...
<html lang="es">
    <head>
        ...
        <title>Admin Template Horizontal</title>
        <!-- Bootstrap CSS -->    
        ...
        <div class="container index">
          <form class="" id="recuperarClave">        
            <div>
                ...
                <p><a href="index.php" class="btn btn-warning btn-lg">REGRESAR</a></p>
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-primary btn-lg" name="submit" value="Confirmar nueva clave">
                </div>

            </div>
          </form>        
        </div>
        <footer class="footer-purple">Temp Admin - IGabParis 2019</footer>
        <script src="assets/js/jquery-1.10.2.js"></script>
